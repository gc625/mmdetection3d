...
eval_pipeline = [
    ...
    dict(
        ...
        with_label=False),
    dict(type='Collect3D', keys=['points','point_cloud_dims_min','point_cloud_dims_max'])
]
...
test_pipeline = [
    dict(
        ...
        file_client_args=file_client_args),  
    dict(type='PointSample', num_points=16384),
    dict(type='Get3detrData'),
    dict(type='GetPointcloudMinMax'),
    dict(
        type='DefaultFormatBundle3D',
        class_names=class_names,
        with_label=False),
    dict(type='Collect3D', keys=['points','point_cloud_dims_min','point_cloud_dims_max','ret_dict'])
]
